...
def test_pages(mod):
    ...
    assert_true('target="_blank"' in embedded_paid, "Shopify billing link does not open a new tab")
    assert_true('rel="noopener"' in embedded_paid, "Shopify billing link missing noopener")
