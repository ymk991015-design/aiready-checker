...
def main():
    ...
    row = {
        ...
        "scan_completed": summary.get("scan_completed", 0),
        ...
        "installs": summary.get("app_installs", 0),
        "uninstalls": summary.get("app_uninstalls", 0),
        "descriptions_generated": summary.get("description_generated", 0),
        "descriptions_saved": summary.get("description_saved_to_shopify", 0),
        "upgrade_clicks": summary.get("upgrade_clicks", 0),
        "checkout_started": summary.get("checkout_started", 0),
        "checkout_completed": summary.get("checkout_completed", 0),
        "subscription_cancelled": summary.get("subscription_cancelled", 0),
